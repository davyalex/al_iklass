...
class StockPoliciesTest extends TestCase
{
    ...
    public function test_only_gestionnaire_stock_and_admin_can_do_sortie_interne_and_vente(): void
    {
        ...
        // Le chef mécanicien ne sort jamais lui-même le stock : il passe par
        // une demande de sortie auprès du gestionnaire de stock (cf. DemandeSortie).
        $this->assertFalse($chefMecanicien->can('sortieInterne', MouvementStock::class));
