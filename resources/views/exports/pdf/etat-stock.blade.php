...
<head>
    ...
    <style>
        ...
        tfoot td { font-weight: bold; background-color: #f5f9fc; }
...
<body>
    ...
    <table>
        ...
        <tfoot>
            <tr>
                <td colspan="6">Valeur totale du stock</td>
                <td colspan="2">{{ number_format($articles->sum(fn ($a) => (float) $a->quantite_stock * (float) $a->prix_achat), 0, ',', ' ') }} FCFA</td>
            </tr>
        </tfoot>
    </table>
</body>
